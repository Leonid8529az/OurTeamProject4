...
public class RayBanAddOnsAndAccessories extends OurAPI {
    ...
    public void testContactLensesCategoryAndtheirItems () {
        ...
        scroller("1200");
        waitSeconds(5);
        opticalHomePage.selectContactLensAccessories();
        waitSeconds(2);
        Assert.assertEquals( eyeGlassesPath.getText(), "Eye Care");
        scroller("500");
        eyeGlassesPath.selectLumifyEyeDrops();
        waitSeconds(3);
        scroller("300");
        eyeGlassesPath.addTheItemToCard();
