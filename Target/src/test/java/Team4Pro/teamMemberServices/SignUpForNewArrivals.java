...
public class SignUpForNewArrivals extends OurAPI {
    ...
    @Test
    public void signingUpForNewArrivals () {
        ...
        scroller("700");
        Assert.assertEquals(getTitle(), "Target Bullseye Shop");
        bullseyeHomePage.typeEmailOnSighUpBar("aicabreraa15@gmail.com");
        bullseyeHomePage.clickOnSubmitEmail();
