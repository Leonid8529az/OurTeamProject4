...
public class TopCategories extends OurAPI {
    ...
    public void findTopCategories() {
        ...
        scroller("700");
        bullseyeHomePage.clickOnTopCategory();
        Assert.assertEquals(getTitle(), "Dogs - Target Bullseye Shop");
        waitSeconds(2);
        teamMemberServices.clickOnTopCategory();
        waitSeconds(3);
        scroller("200");
        teamMemberServices.typeQuantity("3");
        waitSeconds(2);
        teamMemberServices.addAllToCard();
